...
if(zen_get_configuration_key_value('USE_PRODUCT_LISTING_FOR_NEW_PRODUCTS')=='True')
{
$use_product_listing = true;
$snaf_listing_split = $products_new_split;

if(zen_get_configuration_key_value('USE_PRODUCT_LISTING_FILTER_FOR_NEW_PRODUCTS')=='True')
{
